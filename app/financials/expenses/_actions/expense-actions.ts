...
export async function getFinancialCategories() {
  ...
  try {
    ...
    return {
      error: error instanceof Error ? error.message : "Kategoriler alınırken hata oluştu",
    }
  }
}
...
export async function getSuppliers() {
  ...
  try {
    ...
    return {
      error: error instanceof Error ? error.message : "Tedarikçiler alınırken hata oluştu",
    }
  }
}
