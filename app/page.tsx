...
async function DashboardContent() {
  try {
    ...
    const customerGrowthPercent = 15.2
            ...
            <Card className="border-0 shadow-lg bg-gradient-to-br from-purple-500 to-purple-600 text-white overflow-hidden relative">
              ...
              <CardContent className="relative z-10">
                ...
                <div className="flex items-center text-purple-100">
                  <ArrowUpRight className="h-4 w-4 mr-1" />
                  <span className="text-sm">+{customerGrowthPercent}% bu ay</span>
                </div>
              </CardContent>
            </Card>
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-4 border-t">
                    ...
                    <div className="text-center">
                      <p className="text-2xl font-bold text-blue-600">
                        ₺{Math.round(stats.totalRevenue / stats.totalCustomers || 0).toLocaleString("tr-TR")}
                      </p>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center">
        <div className="text-center bg-white p-8 rounded-xl shadow-lg">
          ...
          <h3 className="text-xl font-semibold mb-2 text-slate-800">Hata Oluştu</h3>
          <p className="text-slate-600">Dashboard yüklenirken bir hata oluştu.</p>
          <Button className="mt-4" onClick={() => window.location.reload()}>
            Sayfayı Yenile
          </Button>
        </div>
